...
export default function MyProject() {
    return (
        <section style={{backgroundImage: "url('/imh/bg.png')", backgroundSize: "cover"}} className="bg-[#ffffff] p-[100px_300px_50px] 1560:p-[60px_30px_50px] flex flex-col items-center justify-center ">

...
export default function Cv() {
    return (
        ...
        <article id="CV" className="p-[100px_300px_50px] 1560:p-[100px_30px_50px]">

            <div className="w-full relative z-[3] items-center justify-center bg-[#ffffff] rounded-[22px]  drop-shadow-[0_10px_10px_rgba(43,56,76,0.2)]">

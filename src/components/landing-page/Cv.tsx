...
export default function Cv() {
  ...
  return (
    <article
      ...
      id="CV"
      className="p-[100px_300px_50px] 1560:p-[100px_30px_50px] bg-[#ffffff]"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
        ...
        <section className="max-w-[1320px] p-[112px] 1240:p-[30px] flex 695:flex-col gap-[25px] items-center justify-center">
          <div className="relative">
            <Image
              width={424}
              height={468}
              className="max-w-[424px] max-h-[468px] 995:max-w-[212px] 995:max-h-[234px] 695:w-[180px]  rounded-[22px]"
              src={"/img/me.png"}
              alt="#"
              priority
            />
          ...
          <div className="max-w-[536px] flex flex-col gap-[32px]">
            ...
            <div className="flex flex-col gap-[16px]">
              <p className="text-[#556070] text-[18px] 895:text-[12px] font-[400]">
                Specializing in creating modern and high-performance web
                applications for B2B and B2C segments. In my projects, I combine
                aesthetic design, user-friendly interfaces, and reliable
                functionality to help businesses effectively engage with clients
                and partners.
              </p>

              <p className="text-[#556070] text-[18px] 895:text-[12px] font-[400]">
                I have a strong understanding of the needs of different
                audiences and know how to adapt my solutions to achieve the best
                results.
              </p>
            </div>
            ...
            <div className=" flex justify-start ">
              <Link
                ...
                download={true}
                className="group w-[190px] !flex !flex-row items-center gap-[12px] rounded-[6px] border-[1px] justify-center border-[#A53DFF] p-[12px_24px] group hover:bg-[#A53DFF]"
              >
                <svg
                  width="20"
                  height="20"
                ...
                <p className="text-[#A53DFF] text-[16px] font-[600] group-hover:text-[#ffffff]">
                  Download CV
                </p>
              </Link>
            </div>

...
export default function AboutMe() {
    ...
    return (
        <div
            id="about-me"
            className={`flex flex-col items-start justify-start gap-[24px] 795:gap-[16px] my-[24px] px-[100px] 1240:px-[15px] min-h-[100dvh] transition-all duration-700 ease-in-out ${isVisible ? "scale-x-100" : "scale-x-0"
                }`}
        >
